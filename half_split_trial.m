function [first_half,second_half] = half_split_trial(repetition)
% [first_half,second_half] = half_split_trial(repetition,rawdata)
...
% rawdata: the target mat from loaddata
